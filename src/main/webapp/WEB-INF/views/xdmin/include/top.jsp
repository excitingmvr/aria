...
<div class="container-fluid" style="height: 60px;">
    <div class="row h-100">
        <div class="col-4 col-sm-2 my-auto">
            <img src="/resources/xdmin/image/logo_kaionex_1.jpg" class="img-fluid rounded mx-auto d-block">
        </div>
        <div class="col-sm-4 my-auto d-none d-sm-block">
            <p class="mb-0 fs-5 fw-bold">ABC Management System</p>
        </div>
        <div class="col-8 col-sm-2 my-auto text-end">
        ...
        <div class="col-sm-3 my-auto d-none d-sm-block" >
            <div class="row">
                <div class="col my-auto"><img src="/resources/xdmin/image/KakaoTalk_20210928_211658393.jpg" class="image rounded-circle border border-3 float-end" style="width: 40px; height: 40px;" alt="..."></div>
                <div class="col my-auto">
                    <p class="mb-0">Tony Chang</p>
