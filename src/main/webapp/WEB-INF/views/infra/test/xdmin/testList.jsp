...
<script>
	...
	var goUrlList = "/test/testList";					/* #-> */
	var goUrlForm = "/test/testForm";					/* #-> */
	var goUrlMultiUele = "/test/testMultiUele";			/* #-> */
	var goUrlMultiDele = "/test/testMultiDele";			/* #-> */
	
	var excelUri = "/test/excelDownload";					/* #-> */
